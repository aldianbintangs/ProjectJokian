...
<head>
    ...
    <!-- icon -->
    <link href="assets/icon/logo_domain.png" rel="icon">
</head>
<body>
        ...
        <div class="container">
            <nav class="site-navbar">
                <a href="home" class="site-logo">
                    <img class="image"
                         src="assets/icon/logo_header.png"
                         alt="Logo">
                </a>
                <div class="d-flex align-items-center">
                    <div class="MenuItem" id="MenuItems">
                        <a class="item" href="index.html">Home</a>
                        <a class="item" href="event.html">Event</a>
                        <a class="item" href="destination.html">Destination</a>
                        <a class="item" href="package.html">Package</a>
                     </div>
                    <form class="w-100 me-3" role="search">
                        <input type="search" class="form-control" placeholder="Search..." aria-label="Search">
                    </form>
                    <img id="profile-picture" class="rounded-circle profile-picture" src="assets/icon/pp.jpg" width="30" height="30">
...
<main id="landing">
    <div class="container row">
        <div class="col-lg-5 col-md-6 col-12">
            ...
            <a class="landing-button" href="package.html">Travel Now</a>
        </div>
        <div class="col-lg-7 col-md-6 col-12">
            <img src="assets/image/landing.png" alt="Landing" width="600" height="400">
        </div>
    </div>
</main>
<main id="package">
    <div class="container">
        ...
        <div class="row content">
            <div class="col-lg-2 col-md-3 col-6 card text-center">
                <img class="card-img-top" src="assets/image/Bromo.png" alt="Bromo Package Trip">
                <div class="card-body">
                    <h5 class="card-title">Bromo Package Trip</h5>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-6 card text-center">
                <img class="card-img-top" src="assets/image/Tugu.png" alt="Malang Heritage Trip">
                <div class="card-body">
                    <h5 class="card-title">Malang Heritage Trip</h5>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-6 card text-center">
                <img class="card-img-top" src="assets/image/Bakso.png" alt="Culinary Trip">
                <div class="card-body">
                    <h5 class="card-title">Culinary Trip</h5>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-6 card text-center">
                <img class="card-img-top" src="assets/image/Pantai.png" alt="Beach of Malang Trip">
                <div class="card-body">
                    <h5 class="card-title">Beach of Malang Trip</h5>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-6 card text-center">
                <img class="card-img-top" src="assets/image/Agri.png" alt="Agricultural Trip">
                <div class="card-body">
...
<main id="articles">
    ...
    <div class="right-card">
        <img src="assets/image/round_bromo.png" alt="Bromo" width="250" height="250">
        <h1>Gunung Bromo</h1>
    ...
    <div class="left-card">
        <img src="assets/image/round_jp.png" alt="JP" width="250" height="250">
        <h1>Jatim Park</h1>
        ...
        <main id="event">
            <div class="row content">
                <div class="col-lg-4 col-md-6 col-12 card">
                    <img class="card-img-top" src="assets/image/Event1.png"
                    ...
                    <div class="card-body">
                        ...
                        <a href="blog1.html" class="btn btn-primary">See More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12 card">
                    <img class="card-img-top" src="assets/image/Event2.png"
                         alt="Car Free Day">
                    <div class="card-body">
                        <h5 class="card-title">Car Free Day</h5>
                        <p class="card-info">Ijen / Nov 1, 2023</p>
                        <p class="card-text">Car Free Day is a free international event celebrated every Sunday in which people are encouraged to get around without driving 
                            alone in cars and instead ride a train, bus, bicycle, carpool, vanpool, subway, or walk. </p>
                        <a href="blog2.html" class="btn btn-primary">See More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12 card">
                    <img class="card-img-top" src="assets/image/Event3.png"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Experience the elegance and prosperity of women 
                            with a blend of red and gold collections at the Malang Heritage Fashion Festival 2013.</p>
                        <a href="blog3.html" class="btn btn-primary">See More</a>
                    </div>
                </div>
            </div>
        </main>
        ...
        <div class="row content">
            <div class="col-lg-2 card">
                <div class="card-head">
                    ...
                    <img class="petik" src="assets/image/Tandapetik.png" alt="Petik">
                </div>
    ...
    <div class="container">
        <div class="row content">
            <div class="col-lg-6 item1">
                <h1><img src="assets/icon/logo_domain.png" alt="Logo PM" width="100" height="70">Visit Malang</h1>
            ...
            <div class="col-lg-6 item2">
                <h1>Our Contacts</h1>
                <div class="iconft">
                    <a href="https://wa.me/082310304998"><img src="assets/image/wassap.png" alt="wassap"></a>
                    <a href="https://www.facebook.com/visitmalang/"><img src="assets/image/efbi.png"
                                                                                         alt="efbi"></a>
