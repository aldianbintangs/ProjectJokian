            ...
            <nav class="site-navbar">
                ...
                <div class="d-flex align-items-center">
                    <div class="MenuItem" id="MenuItems">
                        ...
                        <div class="dropdown">
                            <a class="item dropdown-toggle" href="#" role="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                Profile
                            </a>
                    ...
                    <a href="{{ route("profile.edit") }}">
                        @if (Auth::user()->foto)
                            <img src="{{ asset('storage/' . Auth::user()->foto) }}" alt="Profile Picture" class="profile-picture">
                        @else
                            <img src="{{ asset('default-profile.png') }}" alt="Default Profile Picture" class="profile-picture">
                        @endif
                    </a>
                </div>
            </nav>
    ...
    <div class="container article">
        ...
        <main id="event">
            <div class="row content">
                ...
                <div class="col-lg-4 col-md-6 col-12 card">
                    <img class="card-img-top" src="{{ asset("assets/image/Event2.png") }}"
                         alt="Car Free Day">
                    <div class="card-body">
    ...
    <div class="container">
        ...
        <div class="row content">
            <div class="col-lg-2 card">
                <div class="card-head">
                    <img class="profile card-img-top" src="{{ asset("assets/image/ari.png") }}" alt="ari wibowo">
                    <div class="card-name">
            ...
            <div class="col-lg-2 card">
                <div class="card-head">
                    <img class="profile card-img-top" src="{{ asset("assets/image/ronaldo.png") }}" alt="christian ronaldo">
                    <div class="card-name">
            ...
            <div class="col-lg-2 card">
                <div class="card-head">
                    <img class="profile card-img-top" src="{{ asset("assets/image/eddi.png") }}" alt="eddi brokoli">
                    <div class="card-name">
            ...
            <div class="col-lg-2 card">
                <div class="card-head">
                    <img class="profile card-img-top" src="{{ asset("assets/image/rio.png") }}" alt="Rio Dewanto">
                    <div class="card-name">
            ...
            <div class="col-lg-2 card">
                <div class="card-head">
                    <img class="profile card-img-top" src="{{ asset("assets/image/olivia.png") }}" alt="Olivia Zalianty">
                    <div class="card-name">
    ...
    <div class="container">
        <div class="row content">
            <div class="col-lg-6 item1">
                <h1><img src="{{ asset("assets/icon/logo_domain.png") }}" alt="Logo PM" width="100" height="70">Visit Malang</h1>
            ...
            <div class="col-lg-6 item2">
                <h1>Our Contacts</h1>
                <div class="iconft">
                    <a href="https://wa.me/082310304998"><img src="{{ asset("assets/image/wassap.png") }}" alt="wassap"></a>
                    <a href="https://www.facebook.com/visitmalang/"><img src="{{ asset("assets/image/efbi.png") }}"
                                                                                         alt="efbi"></a>
